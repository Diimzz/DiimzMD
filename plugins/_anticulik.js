...
export async function all(m) {
    ...
    if ((m.mtype === 'groupInviteMessage' || m.text.startsWith('https://chat.whatsapp.com') || m.text.startsWith('Buka tautan ini')) || m.text.startsWith('Undangan untuk bergabung') || && !m.isBaileys && !m.isGroup) {
